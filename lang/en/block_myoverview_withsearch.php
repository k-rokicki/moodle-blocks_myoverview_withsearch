...
/**
 * Lang strings for the My overview with search block.
 *
...
$string['list'] = 'List';
$string['myoverview_withsearch:myaddinstance'] = 'Add a new course overview block to Dashboard';
$string['nocustomvalue'] = 'No {$a}';
$string['past'] = 'Past';
$string['pluginname'] = 'Course overview with search';
...
$string['clearsearchinput'] = 'Clear search input';
