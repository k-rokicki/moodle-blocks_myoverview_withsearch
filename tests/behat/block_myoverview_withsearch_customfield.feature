...
Feature: The my overview with search block allows users to group courses by custom fields
  ...
  Scenario: Group courses by checkbox: Yes
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1             | block_myoverview_withsearch |
      | customfiltergrouping       | checkboxfield | block_myoverview_withsearch |
  ...
  Scenario: Group courses by date: 1 February 2001
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1         | block_myoverview_withsearch |
      | customfiltergrouping       | datefield | block_myoverview_withsearch |
    And I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
  ...
  Scenario: Group courses by select: Option 1
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1           | block_myoverview_withsearch |
      | customfiltergrouping       | selectfield | block_myoverview_withsearch |
    And I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
  ...
  Scenario: Group courses by text: fish
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1         | block_myoverview_withsearch |
      | customfiltergrouping       | textfield | block_myoverview_withsearch |
    And I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
  ...
  Scenario: Hidden fields not displayed in the filter
    Given the following config values are set as admin:
      | displaygroupingcustomfield | 1          | block_myoverview_withsearch |
      | customfiltergrouping       | textfield2 | block_myoverview_withsearch |
