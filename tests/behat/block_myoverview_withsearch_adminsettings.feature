@block @block_myoverview_withsearch @javascript
Feature: The my overview with search block allows admins to easily configure the students' course list
  In order to adapt the my overview with search block to my users' needs
  As an admin
  I can configure the appearance of the my overview with search block
  ...
  Scenario: Enable 'All' course filter option
    ...
    Then "[data-value='allincludinghidden']" "css_element" should exist in the ".block_myoverview_withsearch .dropdown-menu" "css_element"
  ...
  Scenario: Disable 'All' course filter option
    ...
    Then "[data-value='allincludinghidden']" "css_element" should not exist in the ".block_myoverview_withsearch .dropdown-menu" "css_element"
  ...
  Scenario: Enable 'All (except removed from view)' course filter option
    ...
    Then I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
    Then "All (except removed from view)" "list_item" should exist in the ".block_myoverview_withsearch .dropdown-menu" "css_element"
  ...
  Scenario: Disable 'All (except removed from view)' course filter option
    ...
    Then "All (except removed from view)" "list_item" should not exist in the ".block_myoverview_withsearch .dropdown-menu" "css_element"
  ...
  Scenario: Enable 'In progress' course filter option
    ...
    Then I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
    Then "In progress" "list_item" should exist in the ".block_myoverview_withsearch .dropdown-menu" "css_element"
  ...
  Scenario: Disable 'In progress' course filter option
    ...
    Then I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
    Then "In progress" "list_item" should not exist in the ".block_myoverview_withsearch .dropdown-menu" "css_element"
  ...
  Scenario: Enable 'Future' course filter option
    ...
    Then I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
    Then "Future" "list_item" should exist in the ".block_myoverview_withsearch .dropdown-menu" "css_element"
  ...
  Scenario: Disable 'Future' course filter option
    ...
    Then I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
    Then "Future" "list_item" should not exist in the ".block_myoverview_withsearch .dropdown-menu" "css_element"
  ...
  Scenario: Enable 'Past' course filter option
    ...
    Then I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
    Then "Past" "list_item" should exist in the ".block_myoverview_withsearch .dropdown-menu" "css_element"
  ...
  Scenario: Disable 'Past' course filter option
    ...
    Then I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
    Then "Past" "list_item" should not exist in the ".block_myoverview_withsearch .dropdown-menu" "css_element"
  ...
  Scenario: Enable 'Starred' course filter option
    ...
    Then I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
    Then "Starred" "list_item" should exist in the ".block_myoverview_withsearch .dropdown-menu" "css_element"
  ...
  Scenario: Disable 'Starred' course filter option
    ...
    Then I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
    Then "Starred" "list_item" should not exist in the ".block_myoverview_withsearch .dropdown-menu" "css_element"
  ...
  Scenario: Enable 'Removed courses' course filter option
    ...
    Then I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
    Then "Removed from view" "list_item" should exist in the ".block_myoverview_withsearch .dropdown-menu" "css_element"
  ...
  Scenario: Disable 'Removed courses' course filter option
    ...
    Then I log in as "student1"
    And I click on "All (except removed from view)" "button" in the "Course overview" "block"
    Then "Removed from view" "list_item" should not exist in the ".block_myoverview_withsearch .dropdown-menu" "css_element"
  ...
  Scenario: Disable all course filter options
    ...
    Then "button#groupingdropdown" "css_element" should not exist in the ".block_myoverview_withsearch" "css_element"
