 ...
 * @copyright  based on work by 2019 Juan Leyva <juan@moodle.com>
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_myoverview_withsearch_testcase extends advanced_testcase {
    ...
    public function test_get_block_config_for_external() {
        ...
        set_config('displaygroupingcustomfield', 1, 'block_myoverview_withsearch');
        set_config('customfiltergrouping', $field->get('shortname'), 'block_myoverview_withsearch');
        ...
        $PAGE->blocks->add_block('myoverview_withsearch', 'content', 0, false);
        ...
        foreach ($blocks as $region => $regionblocks) {
            ...
            foreach ($regioninstances as $ri) {
                // Look for myoverview_withsearch block only.
                if ($ri->instance->blockname == 'myoverview_withsearch') {
        ...
        $this->assertEquals(get_config('block_myoverview_withsearch', 'version'), $configs->plugin->version);
        // Test custom fields.
