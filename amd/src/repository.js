 ...
 *
 * @module     block_myoverview_withsearch/repository
 * @copyright  2022 Kacper Rokicki <k.k.rokicki@gmail.com>
 * @copyright  based on work by 2018 Bas Brands <base@moodle.com>
...
define(['core/ajax', 'core/notification'], function(Ajax, Notification) {
     ...
     * string search            course name filter
     *
    ...
    var getEnrolledCoursesByTimeline = function(args) {
        ...
        var request = {
            methodname: 'get_enrolled_courses_by_timeline_classification_with_search',
            args: args
        };
