...
/**
 * Manage the timeline view navigation for the my overview with search block.
 *
...
[
    ...
    'block_myoverview_withsearch/view',
...
function(
    ...
    var updatePreferences = function(filter, value) {
        var type = null;
        if (filter == 'display') {
            type = 'block_myoverview_withsearch_user_view_preference';
        } else if (filter == 'sort') {
            type = 'block_myoverview_withsearch_user_sort_preference';
        } else if (filter == 'customfieldvalue') {
            type = 'block_myoverview_withsearch_user_grouping_customfieldvalue_preference';
        } else {
            type = 'block_myoverview_withsearch_user_grouping_preference';
        }
     ...
     *
     * @param {object} root The root element for the myoverview_withsearch block
     */
