...
require_once($CFG->dirroot."/blocks/myoverview_withsearch/course_lib.php");
 ...
 * @since Moodle 2.2
 */
class myoverview_withsearch_external extends external_api {
        ...
        return new external_function_parameters(
            array(
                ...
                'customfieldvalue' => new external_value(PARAM_RAW, 'Used when classification = customfield',
                    VALUE_DEFAULT, null),
                'search' => new external_value(PARAM_TEXT, 'Course name filter', VALUE_DEFAULT, null),
            )
        );
    }
     ...
     * @param  string $search Course name filter
     * @return array list of courses and warnings
     * @throws  invalid_parameter_exception
     */
    public static function get_enrolled_courses_by_timeline_classification(
        ...
        if ($classification == COURSE_TIMELINE_ALLINCLUDINGHIDDEN) {
            $courses = course_get_enrolled_courses_for_logged_in_user_with_search(0, $offset, $sort, $fields, COURSE_DB_QUERY_LIMIT, [], [], $search);
            ...
            $courses = course_get_enrolled_courses_for_logged_in_user_with_search(0, $offset, $sort, $fields,
                COURSE_DB_QUERY_LIMIT, $hiddencourses, [], $search);
